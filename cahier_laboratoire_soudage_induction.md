...
**Auteur** : ______________________
**Institution** : ÉTS — Montréal
**Période de la campagne** : ____ / ____ / 2026 → ____ / ____ / 2026
**Version du document** : 0.1 (ébauche — à compléter)
...
| Dimensions laminés | ______ × ______ × ______ mm (à consigner) |
| Recouvrement (overlap) | ______ mm |
| Lot matière / traçabilité | ______ |
...
Concentrateur de flux (+ bobine d'induction)
   ↓
Céramique d'espacement (épaisseur : ______ mm, matériau : ______)
   ↓
...
Laminé inférieur
   ↓
Support / enclume (matériau : ______)
```

**Caractéristique distinctive du setup** : la pression de consolidation est appliquée directement au droit de la zone de chauffe maximale (le twill supérieur), sans outillage de pression séparé. **Aucun confinement latéral** des bords du laminé dans cette série.
...
| Paramètre | Valeur |
|---|---|
| Générateur (marque / modèle) | ______ |
| Fréquence | ______ kHz |
| Distance bobine–laminé (gap) | ______ mm |
| Instrumentation température | ______ (thermocouples ? position ? caméra IR ?) |
| Acquisition | ______ (fréquence d'échantillonnage, logiciel) |
...
| Pression appliquée | ______ (valeur de référence) |
| Phase d'application de la pression | ______ (chauffe seule ? chauffe + refroidissement ?) |
| Température max atteinte (interface / surface) | ______ / ______ °C |
| Refroidissement | ______ (naturel ? actif ?) |
...
**Comparaison A-1 vs A-2 (répétabilité à 250 A)** : ______
...
**Observations qualitatives** : défaut présent également à courant réduit. Sévérité relative vs 250 A : ______
